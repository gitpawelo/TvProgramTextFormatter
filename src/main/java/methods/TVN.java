...
public class TVN {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String path = "E:\\IdeaProjects\\ProgramObrobkaPlikowTV\\documents\\input\\TVN.txt";
        String pathOut = "E:\\IdeaProjects\\ProgramObrobkaPlikowTV\\documents\\tempFiles\\outputTVN_1.txt";
        String pathOut2 = "E:\\IdeaProjects\\ProgramObrobkaPlikowTV\\documents\\tempFiles\\outputTVN_2.txt";
        String pathOut3 = "E:\\IdeaProjects\\ProgramObrobkaPlikowTV\\documents\\tempFiles\\outputTVN_3.txt";
        String finalOut = "E:\\IdeaProjects\\ProgramObrobkaPlikowTV\\documents\\output\\finalTVN.txt";
        ...
        try {
            ...
            while ((line2 = reader.readLine()) != null) {
                writer.write(line2
                        .replace("Fakty - informacje ", "Fakty")
                        .replace("Sport - informacje", "Sport")
                        .replace("Pogoda - informacje ", "Pogoda")
                );
